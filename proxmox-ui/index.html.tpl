...
<html>
  <head>
    ...
    <title>[% nodename %] - Proxmox Virtual Environment Swag</title>
    ...
    <!-- Custom Dashboard -->
    <link rel="stylesheet" type="text/css" href="/pve2/css/custom-dashboard.css" />
    <script type="text/javascript" src="/pve2/js/custom-dashboard.js"></script>
